...
function bankSelect(account = {}) {
  return `
    <div class="bank-picker full-field" role="radiogroup" aria-label="Choose payout bank">
      <span>Bank</span>
      <div class="bank-grid">
        ${NIGERIAN_BANKS.map(
          (bank) => `
      ...
      <div class="earn-dashboard tilt-card">
        <aside class="earn-sidebar">
          ...
          <nav class="earn-menu" aria-label="Earn with Nexora dashboard">
            <a href="#earnDashboard"><i data-lucide="layout-dashboard"></i> Overview</a>
            <a href="#payoutSettings"><i data-lucide="badge-check"></i> Payout settings</a>
            <a href="#withdrawalRequest"><i data-lucide="send"></i> Withdrawals</a>
            <a href="#offers"><i data-lucide="shopping-bag"></i> Offers</a>
          </nav>
