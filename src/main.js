...
const AFFILIATE_ACCOUNTS_KEY = "nexoraAffiliateAccountsV3";
const WITHDRAWALS_KEY = "nexoraWithdrawalsV3";
...
const WELCOME_AFTER_REGISTER_KEY = "nexoraWelcomeAfterRegisterV1";
...
const NIGERIAN_BANKS = [
  { name: "Access Bank", code: "044", domain: "accessbankplc.com", initials: "AB" },
  { name: "Citibank Nigeria", code: "023", domain: "citigroup.com", initials: "CB" },
  { name: "Ecobank Nigeria", code: "050", domain: "ecobank.com", initials: "EB" },
  { name: "Fidelity Bank", code: "070", domain: "fidelitybank.ng", initials: "FB" },
  { name: "First Bank", code: "011", domain: "firstbanknigeria.com", initials: "FBN" },
  { name: "FCMB", code: "214", domain: "fcmb.com", initials: "FC" },
  { name: "GTBank", code: "058", domain: "gtbank.com", initials: "GT" },
  { name: "Jaiz Bank", code: "301", domain: "jaizbankplc.com", initials: "JZ" },
  { name: "Keystone Bank", code: "082", domain: "keystonebankng.com", initials: "KB" },
  { name: "Kuda Microfinance Bank", code: "50211", domain: "kuda.com", initials: "KD" },
  { name: "Moniepoint Microfinance Bank", code: "50515", domain: "moniepoint.com", initials: "MP" },
  { name: "Opay", code: "999992", domain: "opayweb.com", initials: "OP" },
  { name: "PalmPay", code: "999991", domain: "palmpay.com", initials: "PP" },
  { name: "Polaris Bank", code: "076", domain: "polarisbanklimited.com", initials: "PB" },
  { name: "Providus Bank", code: "101", domain: "providusbank.com", initials: "PV" },
  { name: "Stanbic IBTC Bank", code: "221", domain: "stanbicibtcbank.com", initials: "SI" },
  { name: "Standard Chartered", code: "068", domain: "sc.com", initials: "SC" },
  { name: "Sterling Bank", code: "232", domain: "sterling.ng", initials: "SB" },
  { name: "Titan Trust Bank", code: "102", domain: "titantrustbank.com", initials: "TT" },
  { name: "Union Bank", code: "032", domain: "unionbankng.com", initials: "UB" },
  { name: "UBA", code: "033", domain: "ubagroup.com", initials: "UBA" },
  { name: "Unity Bank", code: "215", domain: "unitybankng.com", initials: "UN" },
  { name: "VFD Microfinance Bank", code: "566", domain: "vbank.ng", initials: "V" },
  { name: "Wema Bank", code: "035", domain: "wemabank.com", initials: "WB" },
  { name: "Zenith Bank", code: "057", domain: "zenithbank.com", initials: "ZB" }
];
...
const serviceLinks = [
  ...
  },
  {
    id: "affiliate",
    icon: "link-2",
    title: "Earn with Nexora",
    tag: "Commission hub",
    href: "affiliate-marketing.html",
    body: "Promote selected Nexora opportunities, track commissions, and request payouts through a premium earning dashboard."
  },
  {
    id: "academy",
    icon: "graduation-cap",
...
const defaultContent = {
  ...
  graphics: {
    ...
    portfolio: [
      { id: "graphics-port-1", title: "Logo on Building", category: "Brand mockup", body: "Premium wall-sign logo presentation.", imageUrl: "https://images.unsplash.com/photo-1559028012-481c04fa702d?auto=format&fit=crop&w=1200&q=80", active: true },
      { id: "graphics-port-2", title: "Flyer in Hand", category: "Print mockup", body: "Event flyer shown in a realistic campaign setting.", imageUrl: "https://images.unsplash.com/photo-1586717791821-3f44a563fa4c?auto=format&fit=crop&w=1200&q=80", active: true },
      { id: "graphics-port-3", title: "Instagram UI Preview", category: "Social mockup", body: "Social posts inside a clean mobile feed preview.", imageUrl: "https://images.unsplash.com/photo-1611162616305-c69b3fa7fbe0?auto=format&fit=crop&w=1200&q=80", active: true },
      { id: "graphics-port-4", title: "Brand Kit Scene", category: "Identity", body: "Logo, colors, fonts, and usage direction in one view.", imageUrl: "https://images.unsplash.com/photo-1602576666092-bf6447a729fc?auto=format&fit=crop&w=1200&q=80", active: true }
    ],
    marketplace: [
      { id: "graphics-market-1", title: "Luxury Logo Template", category: "Logo", price: "₦25,000", body: "Editable premium logo direction with mockup preview.", demoUrl: "graphics-design.html#graphicsPortfolio", imageUrl: "https://images.unsplash.com/photo-1559028012-481c04fa702d?auto=format&fit=crop&w=1200&q=80", active: true },
      { id: "graphics-market-2", title: "Social Media Pack", category: "Social", price: "₦45,000", body: "Post, story, banner, and ad creative templates.", demoUrl: "graphics-design.html#graphicsPortfolio", imageUrl: "https://images.unsplash.com/photo-1611162616305-c69b3fa7fbe0?auto=format&fit=crop&w=1200&q=80", active: true },
      { id: "graphics-market-3", title: "Event Flyer Template", category: "Flyer", price: "₦18,000", body: "Clean event flyer layout with print and social sizes.", demoUrl: "graphics-design.html#graphicsPortfolio", imageUrl: "https://images.unsplash.com/photo-1586717791821-3f44a563fa4c?auto=format&fit=crop&w=1200&q=80", active: true }
    ],
    reviews: [
  ...
  realEstate: {
    listings: [
      { id: "estate-1", title: "Modern 3-Bedroom Apartment", price: "₦450,000/year", location: "Lekki, Lagos", type: "Apartment", mode: "Rent", body: "Bright rooms, fitted kitchen, secure estate, and easy road access.", details: "Includes ensuite rooms, fitted kitchen, prepaid meter, gated security, parking, and quick inspection scheduling with Nexora Agents.", imageUrl: "https://images.unsplash.com/photo-1560518883-ce09059eeffa?auto=format&fit=crop&w=1200&q=80", status: "available", active: true },
      { id: "estate-2", title: "Luxury Duplex With BQ", price: "₦180,000,000", location: "Ajah, Lagos", type: "Duplex", mode: "Buy", body: "Spacious duplex with premium finish, parking, and family-friendly layout.", details: "Five bedrooms, BQ, fitted kitchen, family lounge, POP ceiling, water treatment, ample parking, and verified title review support.", imageUrl: "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&w=1200&q=80", status: "available", active: true },
      { id: "estate-3", title: "Prime Commercial Shop", price: "₦850,000/year", location: "Ikeja, Lagos", type: "Shop", mode: "Rent", body: "High-footfall location for retail, service brands, or office use.", details: "Road-facing unit with strong customer access, signage visibility, nearby parking, and flexible inspection window.", imageUrl: "https://images.unsplash.com/photo-1494526585095-c41746248156?auto=format&fit=crop&w=1200&q=80", status: "available", active: true },
      { id: "estate-4", title: "Dry Land Plot", price: "₦30,000,000", location: "Ibeju-Lekki, Lagos", type: "Land", mode: "Buy", body: "Verified land option near developing commercial corridors.", details: "Dry plot with accessible road, developing neighborhood, survey/title review support, and guided consultation before payment.", imageUrl: "https://images.unsplash.com/photo-1500382017468-9049fed747ef?auto=format&fit=crop&w=1200&q=80", status: "sold", active: true }
    ],
    services: [
  ...
  affiliate: {
    categories: ["Commission Offers", "Tools & Software", "Learning Platforms", "Business Resources"],
    offers: [
      { id: "aff-offer-1", title: "Nexora Commission Partner", category: "Commission Offers", benefit: "Earn structured commissions by promoting selected Nexora offers with a premium partner dashboard.", audience: "Beginners and creators who want clean earning systems", price: "Free signup", demoUrl: "affiliate-marketing.html#earnDashboard", imageUrl: "https://images.unsplash.com/photo-1554224155-6726b3ff858f?auto=format&fit=crop&w=1200&q=80", active: true },
    ...
    proof: ["Premium commission dashboard", "Transparent withdrawal tracking", "Verified payout account setup"],
    bonusTitle: "Earn with Nexora",
    bonusBody: "Promote credible digital offers, track your commission activity, and request payouts through a structured Nexora partner system."
  },
  academy: {
    courses: [
      {
        ...
        details: "A practical route from layout structure to deployed projects, including responsive design, frontend workflow, and client-ready delivery habits.",
      ...
      },
      {
        ...
        details: "Learn design thinking, composition, brand systems, social layouts, and how to present work with realistic mockups.",
      ...
      },
      {
        ...
        details: "Understand offer selection, content funnels, honest product positioning, tracking discipline, and commission-focused workflows.",
      ...
      },
      {
        ...
        details: "Plan campaign objectives, build audiences, structure creatives, read metrics, and improve campaigns without wasting budget.",
  ...
  return `
    ...
    <section class="content-band reveal" id="propertySearch">
      ...
      <form class="property-search tilt-card" data-property-search>
        ...
        ${selectField("price", "Price range", ["Any", "Under ₦200K", "₦200K - ₦500K", "₦500K - ₦1M", "₦1M+"])}
...
function bankLogo(bank = {}) {
  return `https://www.google.com/s2/favicons?sz=64&domain=${encodeURIComponent(bank.domain || "")}`;
}

function bankSelect(account = {}) {
  return `
    <details class="bank-picker full-field"${account.bankCode ? "" : " open"}>
      <summary>
        <span><i data-lucide="badge-check"></i> Bank</span>
        <strong>${account.bankName ? esc(account.bankName) : "Choose payout bank"}</strong>
      </summary>
      <div class="bank-grid" role="radiogroup" aria-label="Choose payout bank">
        ${NIGERIAN_BANKS.map(
          (bank) => `
            <label class="bank-option">
              <input type="radio" name="bankPick" value="${attr(`${bank.code}|${bank.name}`)}"${account.bankCode === bank.code ? " checked" : ""} required>
              <span class="bank-logo" aria-hidden="true">
                <img src="${attr(bankLogo(bank))}" alt="" loading="lazy">
                <strong>${esc(bank.initials || bank.name.slice(0, 2))}</strong>
              </span>
              <span class="bank-name">${esc(bank.name)}</span>
            </label>
          `
        ).join("")}
      </div>
...
function withdrawalRows(withdrawals = []) {
  return withdrawals
    .map(
      (item) => `
        <div class="earn-row">
          <span>${money(item.amount)}</span>
          <strong class="${withdrawalStatusClass(item.status)}">${esc(item.status)}</strong>
...
function earnDashboard() {
  const user = getCurrentUser();
  const account = getAffiliateAccount(user?.id) || {};
  const withdrawals = getWithdrawals(user?.id);
  const pending = withdrawals.filter((item) => item.status === "pending").reduce((sum, item) => sum + Number(item.amount || 0), 0);
  const paid = withdrawals.filter((item) => item.status === "successful").reduce((sum, item) => sum + Number(item.amount || 0), 0);
  const declined = withdrawals.filter((item) => item.status === "declined").reduce((sum, item) => sum + Number(item.amount || 0), 0);
  const requested = withdrawals.reduce((sum, item) => sum + Number(item.amount || 0), 0);

  return `
    <section class="content-band reveal" id="earnDashboard">
      ${sectionHeader("member dashboard", "Track commission activity, payout details, withdrawal requests, and payout status in one place.", "#payoutSettings", "Payout settings")}
      <div class="earn-dashboard tilt-card">
        <aside class="earn-sidebar">
          <div class="earn-member">
            <span class="icon-block"><i data-lucide="sparkles"></i></span>
            <div>
              <strong>${esc(user?.fullName || user?.username || "Nexora Partner")}</strong>
              <small>${esc(user?.username || "member")}</small>
            </div>
          </div>
          <nav class="earn-menu" aria-label="Earn with Nexora dashboard">
            <a href="#earnDashboard"><i data-lucide="layout-dashboard"></i><span>Overview</span></a>
            <a href="#payoutSettings"><i data-lucide="badge-check"></i><span>Payout settings</span></a>
            <a href="#withdrawalRequest"><i data-lucide="send"></i><span>Withdrawals</span></a>
            <a href="#offers"><i data-lucide="shopping-bag"></i><span>Offers</span></a>
          </nav>
          <div class="earn-sidebar-note">
            <small>Payout account</small>
            <strong>${account.accountName ? esc(account.accountName) : "Not verified yet"}</strong>
            <span>${account.bankName ? esc(account.bankName) : "Choose your bank"}</span>
          </div>
        </aside>
        <div class="earn-main">
          <div class="earn-hero-panel">
            <div>
              <p class="eyebrow"><i data-lucide="dollar-sign"></i> Partner wallet</p>
              <h3>Earn, track, request, and manage your Nexora commissions from one dashboard.</h3>
            </div>
            <a class="btn btn-primary" href="#payoutSettings"><i data-lucide="check"></i> Setup payout</a>
          </div>
          <div class="earn-metrics">
            ${metricCard("Available Commission", money(Number(account.availableBalance || 0)), "dollar-sign", "metric-card-featured")}
            ${metricCard("Pending Withdrawal", money(pending), "calendar-check")}
            ${metricCard("Successful Payouts", money(paid), "badge-check")}
            ${metricCard("Declined Requests", money(declined), "x")}
            ${metricCard("Total Requested", money(requested), "clipboard-list")}
          </div>
          <div class="earn-panels">
            <form class="earn-panel" data-payout-account id="payoutSettings">
              <h3>Payout settings</h3>
              <div class="form-grid">
                ${bankSelect(account)}
                <label>Account number<input name="accountNumber" type="text" inputmode="numeric" value="${attr(account.accountNumber || "")}" placeholder="10 digit account number" required></label>
                <label class="full-field">Verified account name<input name="accountName" type="text" value="${attr(account.accountName || "")}" placeholder="Verify to load account name" readonly required></label>
              </div>
              <div class="hero-actions">
                <button class="btn btn-ghost" type="button" data-verify-bank><i data-lucide="badge-check"></i> Verify account</button>
                <button class="btn btn-primary" type="submit"><i data-lucide="check"></i> Save account details</button>
              </div>
              <p class="form-status" data-payout-status role="status"></p>
            </form>
            <form class="earn-panel" data-withdrawal-request id="withdrawalRequest">
              <h3>Request withdrawal</h3>
              <label>Amount<input name="amount" type="number" min="1000" step="100" placeholder="1000" required></label>
              <button class="btn btn-primary" type="submit"><i data-lucide="send"></i> Submit withdrawal request</button>
              <p class="form-status" data-withdraw-status role="status"></p>
              <div class="withdrawal-history">
                <strong>Withdrawal history</strong>
                ${withdrawalRows(withdrawals) || '<p class="empty-note">No withdrawal requests yet.</p>'}
              </div>
            </form>
          </div>
        </div>
...
function affiliatePage(content) {
  ...
  return `
    ${hero({
      scene: "affiliate",
      eyebrow: "Earn with Nexora",
      title: "Earn Commission Through Nexora",
      copy: "A premium partner experience for promoting credible Nexora offers, tracking commission activity, and requesting payouts with clarity.",
      primary: { href: "#earnDashboard", label: "Open dashboard", icon: "layout-dashboard" },
      secondary: { href: "#offers", label: "Explore offers", icon: "shopping-bag" },
      consoleTitle: "Earning dashboard"
    })}
    ${earnDashboard()}
    <section class="content-band reveal" id="offers">
      ${sectionHeader("commission offers", "Promote selected offers and keep the earning workflow clean, trackable, and premium.", "#offerFinder", "Find fit")}
    ...
    <section class="content-band web-request-layout reveal" id="offerFinder">
      <div class="section-intro">
        ...
        <h2>Choose your goal and see the most relevant Nexora earning opportunities first.</h2>
      </div>
      <form class="smart-form tilt-card" data-offer-finder>
        ${selectField("need", "What are you looking for?", ["Earn commission", "Grow business", "Learn skills"])}
    ...
    <section class="content-band split-band reveal">
      <div class="section-intro">
        ...
        <h2>Promote approved Nexora offers, track every payout request, and keep your bank details ready for settlement.</h2>
      </div>
    ...
    <div class="admin-shell ${collapsed ? "is-collapsed" : ""}">
      <aside class="admin-sidebar">
        ...
        <nav class="admin-nav" aria-label="Admin navigation">
          ...
          ${adminNavButton("affiliate", "Earn With Nexora", "link-2")}
          ...
          ${adminNavButton("withdrawals", "Withdrawals", "dollar-sign", getWithdrawals().filter((item) => item.status === "pending").length)}
...
function renderAdminSection(section, content, requests, orders) {
  ...
  if (section === "withdrawals") return adminWithdrawals();
  ...
  return `
    <section class="admin-panel">
      <div class="admin-section-head">
        ...
        <h1>Search users, inspect account details, send messages, or manage access.</h1>
      </div>
      <form class="admin-card admin-search-form" data-admin-user-search>
        <label class="full-field">Search by username, name, email, or phone
          <input name="search" type="search" placeholder="Type a username, email, phone, or full name">
        </label>
      </form>
      <div class="request-board">
        ${users
          .map((user) => {
            ...
            const userWithdrawals = withdrawals.filter((item) => item.userId === user.id);
            const pending = userWithdrawals.filter((item) => item.status === "pending").reduce((sum, item) => sum + Number(item.amount || 0), 0);
            const paid = userWithdrawals.filter((item) => item.status === "successful").reduce((sum, item) => sum + Number(item.amount || 0), 0);
            const declined = userWithdrawals.filter((item) => item.status === "declined").reduce((sum, item) => sum + Number(item.amount || 0), 0);
            const searchText = [user.username, user.fullName, user.email, user.phone].join(" ").toLowerCase();
            return `
              <article class="admin-card request-card user-admin-card" data-admin-user-card data-user-id="${attr(user.id)}" data-search="${attr(searchText)}">
                ...
                <div class="admin-detail-grid">
                  ...
                  <p><i data-lucide="lock"></i> Password is securely hashed and cannot be viewed. Set a temporary password if the user needs access restored.</p>
                  <p><i data-lucide="dollar-sign"></i> Pending: ${money(pending)} / Successful: ${money(paid)} / Declined: ${money(declined)}</p>
                </div>
                <div class="admin-sub-card">
                  <strong>Payout details</strong>
                  ${
                    account
                      ? `<p>${esc(account.bankName)} - ${esc(account.accountNumber)} - ${esc(account.accountName || "Not verified")}</p>`
                      : '<p class="empty-note">No payout account saved.</p>'
                  }
                </div>
                <label>Send in-website message
                  <textarea data-admin-user-message rows="3" placeholder="Write a private message to this user"></textarea>
                </label>
                <label>Set temporary password
                  <input data-admin-temp-password type="text" minlength="8" placeholder="Minimum 8 characters">
                </label>
                <p class="form-status" data-admin-user-status role="status"></p>
                <div class="admin-actions">
                  <button class="btn btn-primary" type="button" data-admin-message-user><i data-lucide="message-circle"></i> Send message</button>
                  <button class="btn btn-ghost" type="button" data-admin-reset-password><i data-lucide="lock"></i> Set password</button>
                  <button class="btn btn-danger" type="button" data-admin-delete-user><i data-lucide="trash-2"></i> Delete account</button>
                </div>
...
function adminWithdrawals() {
  ...
  return `
    <section class="admin-panel">
      <div class="admin-section-head">
        <p class="eyebrow"><i data-lucide="dollar-sign"></i> Withdrawal requests</p>
        <h1>Review every Earn with Nexora payout request and update the status.</h1>
      </div>
      <div class="request-board">
        ${withdrawals
          .map(
            (item) => `
              <article class="admin-card request-card" data-withdrawal-id="${attr(item.id)}">
                <div class="request-card-head">
                  <span>${esc(item.username || item.fullName || "User")}</span>
                  <strong>${money(item.amount)}</strong>
                </div>
                <p><i data-lucide="mail"></i> ${esc(item.email || "")}</p>
                <p><i data-lucide="badge-check"></i> ${esc(item.account?.bankName || "")} - ${esc(item.account?.accountNumber || "")} - ${esc(item.account?.accountName || "")}</p>
                <small>${new Date(item.createdAt).toLocaleString()}</small>
                <label>Status
                  <select data-withdrawal-status>
                    ${["pending", "successful", "declined"].map((status) => `<option${item.status === status ? " selected" : ""}>${status}</option>`).join("")}
                  </select>
                </label>
                <p class="form-status" data-withdrawal-admin-status role="status"></p>
                <button class="btn btn-primary" type="button" data-save-withdrawal-status><i data-lucide="check"></i> Save withdrawal status</button>
              </article>
            `
          )
          .join("") || '<div class="admin-card"><p>No withdrawal requests yet.</p></div>'}
      </div>
    </section>
  `;
}
            ...
            (item) => `
              <article class="admin-card request-card" data-request-id="${item.id}">
                ...
                <div class="admin-actions">
                  ...
                  <button class="btn btn-danger" type="button" data-delete-request><i data-lucide="trash-2"></i> Delete request</button>
                </div>
              </article>
            `
          )
...
function portfolioFields() {
  return [
    ...
    { key: "category", label: "Category" },
    { key: "body", label: "Description", type: "textarea" },
    { key: "imageUrl", label: "Real image URL / Upload", type: "image" }
  ];
}
...
function listingFields() {
  return [
    ...
    { key: "body", label: "Description", type: "textarea" },
    { key: "details", label: "Full property details", type: "textarea" },
    { key: "imageUrl", label: "Property image URL / Upload", type: "image" }
  ];
}
...
function affiliateFields() {
  return [
    ...
    { key: "imageUrl", label: "Offer image URL / Upload", type: "image" }
  ];
}
...
function courseFields() {
  return [
    ...
    { key: "details", label: "Full course details", type: "textarea" },
...
function courseCard(course, index) {
  return `
    <article class="course-card tilt-card">
      ${visualMockup({ ...course, category: "Course" }, index, "academy")}
      ...
      <div class="hero-actions">
        <button class="btn btn-ghost" type="button" data-course-details="${attr(course.id)}"><i data-lucide="eye"></i> Learn more</button>
  ...
  return `
    <article class="property-card tilt-card" data-property-card data-mode="${attr(item.mode)}" data-location="${attr(item.location)}" data-type="${attr(item.type)}" data-price="${attr(item.price)}">
      ...
      <div class="property-body">
        ...
        <p>${esc(item.body)}</p>
        <button class="btn btn-ghost" type="button" data-listing-details="${attr(item.id)}"><i data-lucide="eye"></i> Explore more</button>
      </div>
    </article>
  `;
}
...
function nexoraAiWidget() {
  return `
    <aside class="nexora-ai" data-ai-widget>
      <button class="nexora-ai-button" type="button" data-ai-toggle aria-label="Open Nexora GPT">
        <i data-lucide="wand-sparkles"></i>
        <span>Nexora GPT</span>
      </button>
      <section class="nexora-ai-panel" data-ai-panel hidden>
        <header>
          <div>
            <strong>Nexora AI</strong>
            <span>Ask about services, courses, properties, or earning with Nexora.</span>
          </div>
          <button class="icon-btn" type="button" data-ai-close aria-label="Close Nexora AI"><i data-lucide="x"></i></button>
        </header>
        <div class="nexora-ai-messages" data-ai-messages>
          <div class="ai-message ai-bot">Hi, I am Nexora AI. What do you want to do today?</div>
        </div>
        <form class="nexora-ai-form" data-ai-form>
          <input name="message" type="text" placeholder="Ask Nexora GPT..." autocomplete="off" required>
          <button class="btn btn-primary" type="submit" aria-label="Send message"><i data-lucide="send"></i></button>
        </form>
      </section>
    </aside>
  `;
...
function profileModal() {
  ...
  return `
    <div class="request-modal profile-modal" data-profile-modal hidden>
      ...
      <div class="request-modal-card profile-card">
        <span class="icon-block"><i data-lucide="users"></i></span>
        <h2>Your profile</h2>
        <form class="profile-section" data-profile-info-form>
          <div>
            <p class="eyebrow"><i data-lucide="users"></i> Personal information</p>
            <p>Update the public account details connected to your Nexora profile.</p>
          </div>
          <div class="form-grid">
            ...
            <label>Email address<input name="email" type="email" value="${attr(user?.email || "")}" required></label>
            <label>Phone number<input name="phone" type="tel" value="${attr(user?.phone || "")}" required></label>
          </div>
          <button class="btn btn-primary" type="submit"><i data-lucide="check"></i> Save personal information</button>
          <p class="form-status" data-profile-status role="status"></p>
        </form>
        <form class="profile-section" data-password-change-form>
          <div>
            <p class="eyebrow"><i data-lucide="lock"></i> Security password</p>
          ...
          <button class="btn btn-primary" type="submit"><i data-lucide="lock"></i> Change password</button>
          <p class="form-status" data-password-status role="status"></p>
        </form>
        <div class="hero-actions">
...
function showWelcomeAfterRegistration() {
  if (sessionStorage.getItem(WELCOME_AFTER_REGISTER_KEY) !== "true") return;
  const user = getCurrentUser();
  if (!user) return;
  sessionStorage.removeItem(WELCOME_AFTER_REGISTER_KEY);
  showModal(
    `Welcome to Nexora, ${user.fullName || user.username}`,
    "Your account is ready. You can now request services, explore courses, save payout details, and receive direct messages from Nexora inside your profile.",
    "sparkles"
  );
}
  ...
  if (registerForm) {
    registerForm.addEventListener("submit", async (event) => {
      ...
      if (String(data.password || "").length < 8) {
        if (status) status.textContent = "Password must be at least 8 characters long.";
        return;
      }
      try {
        ...
        sharedState.affiliateAccounts = result.affiliateAccount ? [result.affiliateAccount] : [];
        sharedState.withdrawals = result.withdrawals || [];
        sessionStorage.setItem(WELCOME_AFTER_REGISTER_KEY, "true");
        mount();
      } catch (error) {
...
function initProfileControls() {
  ...
  const infoForm = document.querySelector("[data-profile-info-form]");
  ...
  if (infoForm) {
    infoForm.addEventListener("submit", async (event) => {
      event.preventDefault();
      const status = infoForm.querySelector("[data-profile-status]");
      const current = getCurrentUser();
      if (!current) return;
      const data = Object.fromEntries(new FormData(infoForm).entries());
      const username = cleanUsername(data.username);
      const email = String(data.email || "").trim().toLowerCase();
      try {
        ...
        if (status) status.textContent = "Personal information updated.";
  ...
  if (passwordForm) {
    passwordForm.addEventListener("submit", async (event) => {
      ...
      if (String(data.newPassword || "").length < 8) {
        if (status) status.textContent = "New password must be at least 8 characters long.";
        return;
      }
      try {
        ...
        if (status) status.textContent = error.message || "Password change failed.";
      }
    });
  }
}
...
function initCourseDetails(content) {
  document.querySelectorAll("[data-course-details]").forEach((button) => {
    button.addEventListener("click", () => {
      const course = activeItems(content.academy.courses).find((item) => item.id === button.dataset.courseDetails);
      if (!course) return;
      const modal = document.querySelector("[data-global-modal]");
      if (!modal) return;
      ...
      modal.querySelector("[data-modal-message]").innerHTML = `
        <div class="course-modal-body">
          ${visualMockup({ ...course, category: "Course" }, 0, "academy")}
          <p>${esc(course.details || course.body)}</p>
          <ul>${(course.outcomes || []).map((item) => `<li>${esc(item)}</li>`).join("")}</ul>
          <p><strong>${esc(course.price)}</strong> after discount. Access redirect is controlled from the admin dashboard.</p>
        </div>
      `;
      modal.hidden = false;
      document.body.classList.add("modal-open");
...
function initPropertySearch() {
  ...
  form.addEventListener("submit", (event) => {
    ...
    cards.forEach((card) => {
      ...
      const price = priceToNumber(card.dataset.price);
      const matchesPrice =
        data.price === "Any" ||
        (data.price === "Under ₦200K" && price < 200000) ||
        (data.price === "₦200K - ₦500K" && price >= 200000 && price <= 500000) ||
        (data.price === "₦500K - ₦1M" && price > 500000 && price <= 1000000) ||
        (data.price === "₦1M+" && price > 1000000);
      card.hidden = !(matchesMode && matchesType && matchesLocation && matchesPrice);
    });
  });
}
        ...
        <div class="listing-modal-body">
          <div class="listing-gallery">
            ${[listing.imageUrl, ...(listing.gallery || [])]
              .filter(Boolean)
              .slice(0, 3)
              .map((imageUrl, item) => visualMockup({ ...listing, imageUrl, title: `${listing.title} ${item + 1}` }, item, "estate"))
              .join("") || visualMockup(listing, 0, "estate")}
          </div>
          <p><strong>${esc(listing.price)}</strong> - ${esc(listing.location)}</p>
          <p>${esc(listing.body)}</p>
          <p>${esc(listing.details || "Inspection details, title status, availability, and next steps will be confirmed by Nexora Agents.")}</p>
          <a class="btn btn-primary" href="${whatsappHref(`Hello NEXORA, I want to contact/consult Nexora Agents about ${listing.title}.`)}" target="_blank" rel="noopener">${whatsappIcon()} Contact/consult Nexora Agents</a>
        </div>
      `;
      modal.hidden = false;
      document.body.classList.add("modal-open");
...
function initAffiliateFilters() {
  ...
  if (finder) {
    finder.addEventListener("submit", (event) => {
      ...
      const category = need === "Earn commission" ? "Commission Offers" : need === "Learn skills" ? "Learning Platforms" : "Business Resources";
      offers.forEach((offer) => {
...
function parseBankPick(value = "") {
  const [bankCode = "", bankName = ""] = String(value).split("|");
  return { bankCode, bankName };
}

function initEarnDashboard() {
  const payoutForm = document.querySelector("[data-payout-account]");
  const withdrawForm = document.querySelector("[data-withdrawal-request]");

  if (payoutForm) {
    const status = payoutForm.querySelector("[data-payout-status]");
    const verifyButton = payoutForm.querySelector("[data-verify-bank]");
    const accountNameInput = payoutForm.querySelector('input[name="accountName"]');
    let verifyTimer = null;

    verifyButton?.addEventListener("click", async () => {
      const data = Object.fromEntries(new FormData(payoutForm).entries());
      const bank = parseBankPick(data.bankPick);
      if (!bank.bankCode || !data.accountNumber) {
        if (status) status.textContent = "Choose a bank and enter the account number first.";
        return;
      }
      if (status) status.textContent = "Verifying account name...";
      try {
        const result = await apiRequest("/api/affiliate/verify-bank", {
          method: "POST",
          auth: "user",
          body: { bankCode: bank.bankCode, accountNumber: data.accountNumber }
        });
        if (accountNameInput) accountNameInput.value = result.accountName || "";
        if (status) status.textContent = result.accountName ? `Verified: ${result.accountName}` : "Account verified.";
      } catch (error) {
        if (status) status.textContent = error.message || "Could not verify this account.";
      }
    });
    ...
    const scheduleAutoVerify = () => {
      ...
      if (!bank.bankCode || accountNumber.length < 10) return;
      verifyTimer = window.setTimeout(() => verifyButton?.click(), 650);
    };

    payoutForm.querySelectorAll('input[name="bankPick"]').forEach((input) => input.addEventListener("change", scheduleAutoVerify));
    payoutForm.querySelector('input[name="accountNumber"]')?.addEventListener("input", scheduleAutoVerify);
    ...
    payoutForm.addEventListener("submit", async (event) => {
      ...
      const bank = parseBankPick(data.bankPick);
      try {
        const result = await apiRequest("/api/affiliate/account", {
          method: "POST",
          auth: "user",
          body: {
        ...
        saveAffiliateAccount(result.account);
        if (status) status.textContent = "Payout account saved.";
      } catch (error) {
        if (status) status.textContent = error.message || "Could not save payout account.";
      }
    });
  }
  ...
  if (withdrawForm) {
    withdrawForm.addEventListener("submit", async (event) => {
      event.preventDefault();
      const status = withdrawForm.querySelector("[data-withdraw-status]");
      const amount = Number(new FormData(withdrawForm).get("amount") || 0);
      try {
        const result = await apiRequest("/api/affiliate/withdraw", {
          method: "POST",
          auth: "user",
          body: { amount }
        });
        saveWithdrawals(result.withdrawals || [result.withdrawal, ...getWithdrawals(getCurrentUser()?.id)].filter(Boolean));
        if (status) status.textContent = "Withdrawal request submitted. Admin will review the status.";
        window.setTimeout(() => mount(), 700);
      } catch (error) {
        if (status) status.textContent = error.message || "Withdrawal request failed.";
      }
    });
  }
}
...
function initNexoraAI() {
  ...
  form?.addEventListener("submit", async (event) => {
    ...
    appendAiMessage(messages, "Thinking...", "bot");
    const thinking = messages?.lastElementChild;
    try {
      const result = await apiRequest("/api/ai", {
        method: "POST",
        body: { message: question }
      });
      if (thinking) thinking.textContent = result.reply || "Nexora AI could not answer right now.";
    } catch (error) {
      if (thinking) thinking.textContent = error.message || "Nexora AI could not answer right now.";
    }
  });
}
...
function applyAdminState(state) {
  sharedState = normalizeState(state);
...
function initAdmin(content) {
  ...
  document.querySelectorAll("[data-delete-request]").forEach((button) => {
    button.addEventListener("click", () => {
      const card = button.closest("[data-request-id]");
      if (!card || !window.confirm("Delete this request from the admin dashboard?")) return;
      saveRequests(getRequests().filter((item) => item.id !== card.dataset.requestId));
      mount();
    });
  });
  ...
  if (userSearch) {
    userSearch.addEventListener("input", () => {
      const value = String(new FormData(userSearch).get("search") || "").trim().toLowerCase();
      document.querySelectorAll("[data-admin-user-card]").forEach((card) => {
        card.hidden = value && !card.dataset.search.includes(value);
      });
    });
  }

  document.querySelectorAll("[data-admin-message-user]").forEach((button) => {
    button.addEventListener("click", async () => {
      const card = button.closest("[data-admin-user-card]");
      const status = card?.querySelector("[data-admin-user-status]");
      const message = card?.querySelector("[data-admin-user-message]")?.value.trim();
      if (!card || !message) {
      ...
      try {
        applyAdminState(
          await apiRequest("/api/admin/user/message", {
            method: "POST",
            auth: "admin",
            body: { userId: card.dataset.userId, message }
          })
        );
        if (status) status.textContent = "Message sent.";
      } catch (error) {
        if (status) status.textContent = error.message || "Message failed.";
      }
    });
  });
  ...
  document.querySelectorAll("[data-admin-reset-password]").forEach((button) => {
    button.addEventListener("click", async () => {
      const card = button.closest("[data-admin-user-card]");
      const status = card?.querySelector("[data-admin-user-status]");
      const newPassword = card?.querySelector("[data-admin-temp-password]")?.value.trim();
      if (!card || String(newPassword || "").length < 8) {
        if (status) status.textContent = "Temporary password must be at least 8 characters.";
        return;
      }
      try {
        applyAdminState(
          await apiRequest("/api/admin/user/reset-password", {
            method: "POST",
            auth: "admin",
            body: { userId: card.dataset.userId, newPassword }
          })
        );
        if (status) status.textContent = "Temporary password set. Share it privately with the user.";
      } catch (error) {
        if (status) status.textContent = error.message || "Password reset failed.";
      }
    });
  });
  ...
  document.querySelectorAll("[data-admin-delete-user]").forEach((button) => {
    button.addEventListener("click", async () => {
      const card = button.closest("[data-admin-user-card]");
      const status = card?.querySelector("[data-admin-user-status]");
      if (!card || !window.confirm("Delete this user account? This removes their profile, payout details, withdrawals, and notifications.")) return;
      try {
        applyAdminState(
          await apiRequest("/api/admin/user/delete", {
            method: "POST",
            auth: "admin",
            body: { userId: card.dataset.userId }
          })
        );
        mount();
      } catch (error) {
  ...
  document.querySelectorAll("[data-save-withdrawal-status]").forEach((button) => {
    button.addEventListener("click", async () => {
      const card = button.closest("[data-withdrawal-id]");
      const status = card?.querySelector("[data-withdrawal-admin-status]");
      try {
        applyAdminState(
          await apiRequest("/api/admin/withdrawal/status", {
            method: "POST",
            auth: "admin",
            body: {
              id: card.dataset.withdrawalId,
              status: card.querySelector("[data-withdrawal-status]").value
            }
          })
        );
        if (status) status.textContent = "Withdrawal status updated.";
        window.setTimeout(() => mount(), 500);
      } catch (error) {
        if (status) status.textContent = error.message || "Status update failed.";
      }
    });
  });
...
function getAffiliateAccounts() {
  return sharedState?.affiliateAccounts || readJsonLocal(AFFILIATE_ACCOUNTS_KEY, []);
}

function getAffiliateAccount(userId = getCurrentUser()?.id) {
  if (!userId) return null;
  return getAffiliateAccounts().find((item) => item.userId === userId) || null;
}

function saveAffiliateAccount(account) {
  const accounts = getAffiliateAccounts().filter((item) => item.userId !== account.userId);
  accounts.unshift(account);
  sharedState.affiliateAccounts = accounts;
  localStorage.setItem(AFFILIATE_ACCOUNTS_KEY, JSON.stringify(accounts));
}

function getWithdrawals(userId = "") {
  const withdrawals = sharedState?.withdrawals || readJsonLocal(WITHDRAWALS_KEY, []);
  return userId ? withdrawals.filter((item) => item.userId === userId) : withdrawals;
}

function saveWithdrawals(withdrawals) {
  sharedState.withdrawals = withdrawals;
...
async function loadSharedState() {
  ...
  if (userSession?.user) {
    ...
    next.affiliateAccounts = userSession.affiliateAccount ? [userSession.affiliateAccount] : [];
    next.withdrawals = userSession.withdrawals || [];
  ...
  if (currentPage === "admin" && adminToken && !migrated && hasLegacyData(legacy)) {
    ...
    next.affiliateAccounts = mergeById(next.affiliateAccounts, legacy.affiliateAccounts);
    next.withdrawals = mergeById(next.withdrawals, legacy.withdrawals);
...
async function apiRequest(path, options = {}) {
  ...
  const devBases = isLocalPreview ? ["http://localhost:5174", "http://127.0.0.1:5174"] : [];
  const bases = [apiBaseUrl, "", ...devBases].filter((value, index, array) => array.indexOf(value) === index);
...
function normalizeState(state = {}) {
  return {
    ...
    affiliateAccounts: Array.isArray(state.affiliateAccounts) ? state.affiliateAccounts : [],
...
function localStateSnapshot() {
  return normalizeState({
    ...
    affiliateAccounts: readJsonLocal(AFFILIATE_ACCOUNTS_KEY, []),
    withdrawals: readJsonLocal(WITHDRAWALS_KEY, []),
    visits: {
...
function writeLocalBackup(state) {
  ...
  localStorage.setItem(AFFILIATE_ACCOUNTS_KEY, JSON.stringify(state.affiliateAccounts || []));
  localStorage.setItem(WITHDRAWALS_KEY, JSON.stringify(state.withdrawals || []));
...
function hasLegacyData(state) {
  return Boolean(
    Object.keys(state.content || {}).length ||
      ...
      state.affiliateAccounts.length ||
...
function metricCard(label, value, icon, className = "") {
  return `<div class="metric-card ${className} tilt-card"><i data-lucide="${icon}"></i><span>${esc(label)}</span><strong>${esc(value)}</strong></div>`;
}
