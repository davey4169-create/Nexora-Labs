...
function earnDashboard() {
  ...
  return `
    <section class="content-band reveal" id="earnDashboard">
      ${sectionHeader("earning dashboard", "Track commission activity, payout details, and withdrawal status in one place.", "#payoutSettings", "Payout settings")}
      <div class="earn-dashboard tilt-card">
        ...
        <div class="earn-main">
          ...
          <div class="earn-metrics">
            ${metricCard("Available Commission", money(Number(account.availableBalance || 0)), "dollar-sign")}
